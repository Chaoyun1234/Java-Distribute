...
/**
 * Created by v-chzha4 on 9/5/2017.
 */
...
public class MyDistributeListener implements DistributeListener {
    ...
    public boolean onReleaseAvailable(Activity activity, ReleaseDetails releaseDetails) {
        ...
        dialogBuilder.setPositiveButton(com.microsoft.azure.mobile.distribute.R.string.mobile_center_distribute_update_dialog_download,
        ...
        if (!releaseDetails.isMandatoryUpdate()) {
            dialogBuilder.setNegativeButton(com.microsoft.azure.mobile.distribute.R.string.mobile_center_distribute_update_dialog_postpone,
                    new DialogInterface.OnClickListener() {
